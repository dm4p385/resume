...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {SDE Intern}{Jan 2025 -- Present}
      {Vegapay}{Bengaluru, KA}
      \resumeItemListStart
        \resumeItem{Engineered a warm-up mechanism post-deployment which \textbf{reduced} first-hit \textbf{API latency by 76\%}, accelerating processing of high-volume financial transactions and improving overall system responsiveness for users}
...
%-------------------------------------------
    ...
    \resumeSubheading
      {SDE Intern}{Sep 2023 -- Nov 2023}
      {Threely}{Remote}
      \resumeItemListStart
        \resumeItem{Refactored code, \textbf{reduced LOC by 12\%} and performed bug fixes \textbf{increasing system stability} and \textbf{reducing error rates by 15\%}}
        \resumeItem{Developed an end-to-end encrypted system using \textit{REST APIs} and \textit{Private-Public cryptographic keys}}
        \resumeItem{Leveraged \textit{Redis’s pub-sub mechanism} to manage \textit{Websocket connections} and enable message broadcasting}
      \resumeItemListEnd
