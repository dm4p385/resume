  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Developed \textbf{Multi-Currency Reconciliation} solution to automate USD-equivalent tracking using Mastercard’s T140 file, resolving discrepancies and enabling accurate financial reporting for cross currency transactions}
        \resumeItem{Migrated financial reporting queries from \textit{Amazon Athena} to \textit{ClickHouse}, \textit{reducing query execution time by 70\%} and \textit{cutting operational costs by 50\%}, enhancing fraud detection and transaction analytics.}
      \resumeItemListEnd
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Developed an end-to-end encrypted communication system using \textit{REST APIs} and \textit{Private-Public cryptographic keys}}
